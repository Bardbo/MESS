...
# @Last Modified time: 2020-12-30 15:04:26
import osmnx as ox
...
def get_share(i):
    ...
    save_data.to_csv(f'myCode/share_data/sample/delay/sample_all2_{theta}_{pred_time}_{delay}', index=False, mode='a', header=None)
...
if __name__ == "__main__":
    ...
    # i_ls = pd.read_csv('myCode/share_data/sample/last_i', header=None)[0].tolist()
    # i_ls = pd.read_csv('myCode/share_data/sample/last_i2', header=None)[0].tolist()
    # i_ls = pd.read_csv('myCode/share_data/sample/last_i7', header=None)[0].tolist()
    # params = [(i, ) for i in i_ls]
