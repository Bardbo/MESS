...
if __name__ == '__main__':
    ...
    A_wave = get_normalized_dtw_adj(A)
...
#         plt.show()
    ...
    with open(f"save_pk/dtw_4d_stgcn_{epochs}_losses.pk", "wb") as fd:
        pk.dump((training_losses, validation_losses, validation_maes), fd)
    torch.save(net.state_dict(), f'save_pk/dtw_4d_stgcn_{epochs}.pkl')
    end_time = time.time()
